...
void draw() {
  ...
  fill(#EE7F52);                                       // 面の色
  ellipse(0, 0, 100, mouseY);                          // 丸の高さをmouseYで垂直方向の座標に反応させる                           

  fill(#0CAE9D);                                       // 面の色
  ellipse(0, 0, 55, mouseY);                           // 丸の高さをmouseYで垂直方向の座標に反応させる  



  angle += 50.0;                                        // 回転角度を足していく（いろいろな値で試してみてください！）
}
